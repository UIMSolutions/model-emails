  ...
  override void initialize() {
    ...
    this
      .addValues([
        ...
        "regardingObjectTypeCode": IntegerAttributeClass, //The name of the entity linked by regardingObjectId"]),
        ...
        "directionCode": IntegerAttributeClass, //Select the direction of the activity as incoming or outbound."]),
        "statusCode": IntegerAttributeClass, //Select the email's status."]),
        "statusCode_display": StringAttributeClass, //
        "submittedBy": UUIDAttributeClass, //Shows the Microsoft Office Outlook account for the user who submitted the email to Microsoft Dynamics 365."]),
        ...
        "stateCode": IntegerAttributeClass, //Shows whether the email is open, completed, or canceled. Completed and canceled email is read-only and can't be edited."]),
        ...
        "emailSenderObjectTypeCode": IntegerAttributeClass, //The name of the entity linked by emailSender"]),
        "sendersAccount": StringAttributeClass, // Shows the parent account of the sender of the email."]),
        "sendersAccountObjectTypeCode": IntegerAttributeClass, //The name of the entity linked by sendersAccount"]),
        "attachmentCount": StringAttributeClass, // Shows the umber of attachments of the email message."]),
        "parentActivityId": UUIDAttributeClass, // aplActivity").descriptions(["en":"Select the activity that the email is associated with."]),
        ...
        "SLAId": UUIDAttributeClass, // aplSLA").descriptions(["en":"Choose the service level agreement (SLA) that you want to apply to the email record."]),
