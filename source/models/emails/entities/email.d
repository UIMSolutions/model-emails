...
class DAPLEmail : DOOPEntity {
  ...
  override string entityClass() { return "aplEmail"; }
  override string entityClasses() { return "aplEmails"; }
...
auto APLEmail() { return new DAPLEmail; } 
auto APLEmail(Json json) { return new DAPLEmail(json); } 

unittest {
  version(uim_entities) {
    assert(APLEmail);
  
  auto entity = APLEmail;
